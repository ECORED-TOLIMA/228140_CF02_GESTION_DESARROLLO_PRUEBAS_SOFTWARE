...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-12
        figure.mb-4
          img(src="@/assets/curso/Temas/tema3/img1.png" alt="Imagen decorativa código")
          
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10  
        p.mb-4 El #[i CSS] (hojas de estilo en cascada), es la manera en que se da formato a un grupo de elementos del documento #[i HTML]. Cascada, en tanto refiere que los elementos tendrán un formato, teniendo en cuenta la jerarquía.
        .tarjeta.BG02.p-4
          p.mb-0 Se invita a profundizar, entonces, los aspectos más sobresalientes e importantes de las hojas de estilo en cascada (#[i CSS]), estudiando atentamente el video que se presenta a continuación:
      .col-lg-2.d-none.d-lg-block
        figure
          img(src="@/assets/curso/Temas/tema3/img2.svg" alt="Logo #[i CSS]3")
    ...
    .row.justify-content-center.align-items-center.mb-4
      ...
      .col-11
        p.mb-3 Los selectores son utilizados para hacer referencia a las etiquetas del #[i HTML]. Estos selectores están clasificados en ciertos tipos; por lo que en este punto del componente se invita a abordar tales tipos de selectores, explicados en el siguiente video
